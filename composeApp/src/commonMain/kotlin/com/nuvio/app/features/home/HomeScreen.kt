...
fun HomeScreen(
    ...
    val effectiveWatchProgressEntries = remember(
        ...
        val nonAniList = visibleProviderEntries.filter { !it.parentMetaId.startsWith("anilist:", ignoreCase = true) }
    ...
    val allNextUpSeedCandidates = remember(
        ...
        val nonAniList = watchProgressUiState.entries.filter { !it.parentMetaId.startsWith("anilist:", ignoreCase = true) }
